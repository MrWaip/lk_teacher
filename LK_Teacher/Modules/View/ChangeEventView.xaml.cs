...
namespace LK_Teacher.Modules.View
{
    ...
    public partial class ChangeEvent : Window
    {
        ...
        //    if(baseValues == null) baseValues = DBApi.GetDataEvent(eventGridItem.IdEvent);
        ...
        //        {
        //            DBApi.UpdateEvent(eventGridItem.IdEvent,tbTitle.Text, eventGridItem.DayOfEvent, tbDescription.Text, cbTypeEvent.SelectedIndex);
